...
public class VideoFragment extends Fragment {
    ...
    public VideoFragment(String category, List<TeachViewModel> data, RequestQueue requestQueue) {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        TeachItemAdapter adapter = new TeachItemAdapter(data, context, requestQueue);
