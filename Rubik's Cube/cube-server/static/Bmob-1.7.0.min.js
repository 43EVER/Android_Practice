! function(e, t) {
  ...
  return function(e) {
    ...
    (function(t) {
      const o = n(5),
        r = t.Bmob || {};
      r.utils = o, r._config = o.getConfig(), r.initialize = ((e, t, n) => {
        r._config.applicationId = e, r._config.applicationKey = t, r._config.applicationMasterKey = n
      }), e.exports = r
    }).call(t, n(6))
  }, function(e, t, n) {
    "use strict";
    ...
    let o;
    const r = n(5).getAppType();
    "h5" === r ? o = n(10) : "wx" === r ? o = n(41) : "hap" === r ? o = n(42) : "nodejs" === r && (o = n(10)), e.exports = o
  }, function(e, t, n) {
    (function(t, o) {
      let r;
      try {
      ...
      e.exports = {
        ...
        getAppType: () => {
          const e = s();
          let n;
          return n = "undefined" != typeof wx ? "wx" : "undefined" != typeof window ? "h5" : t === o.process ? "nodejs" : 3 === e.type ? "hap" : "h5"
        }
      }
    }).call(t, n(7), n(6))
  }, function(e, t) {
    ...
    e.exports = class {
      constructor(e) {
        this.tableName = `${o._config.parameters.QUERY}/${e}`, this.className = e, this.init(), this.addArray = {}, this.setData = {}
      }
      init() {
      ...
      get(e) {
        ...
        const n = {},
          ...
          y = () => {
            const i = Object.assign(o, t, n, s);
            return "_User" === this.className ? new Promise((t, n) => {
              r(`${this.tableName}/${e}`, "put", i).then(e => {
                const n = this.current();
                let o = Object.assign(n, i);
                p.save("bmob", o), t(e)
              }).catch(e => {
                n(e)
              })
            }) : r(`${this.tableName}/${e}`, "put", i)
          },
          b = {};
        return "" !== this.includes && (b.include = this.includes), new Promise((t, n) => {
          r(`${this.tableName}/${e}`, "get", b).then(n => {
      ...
      set(e, t) {
        ...
        c(n) || c(o) || c(r) ? this.setData[e] = t : this.setData[e] = {
          __type: "File",
          group: o,
          filename: n,
          url: r
      ...
      equalTo(e, t, n) {
        ...
        return Object.keys(this.queryData).length ? c(this.queryData.$and) ? this.queryData = {
          $and: [this.queryData, o]
        } : this.queryData.$and.push(o) : this.queryData = o, o
      }
      containedIn(e, t) {
        if (!i(e) || !u(t)) throw new l(415);
      ...
      or(...e) {
        ...
        if (!c(t)) {
          for (let n = 0; n < t.length; n++)
            for (let o = 0; o < e.length; o++) JSON.stringify(t[n]) === JSON.stringify(e[o]) && this.queryData.$and.splice(n, 1);
        ...
        const n = this.getParams(),
          ...
          i = (n = "updata") => {
            ...
            let u = {
              ...
              p = o._config.parameters.BATCH;
            return r(p, "POST", u)
          };
        return new Promise((e, o) => {
          r(`${this.tableName}`, "get", n).then(o => {
            let r = o.results;
            n.hasOwnProperty("count") && (r = o), this.init(), Object.defineProperty(r, "set", {
              value: s
    ...
    (function(t) {
      ...
      e.exports = function(e) {
        return new Promise(function(l, p) {
          ...
          if ("setRequestHeader" in d && o.forEach(h, function(e, t) {
    ...
    let o;
    const r = n(5).getAppType();
    "h5" === r ? o = n(43) : "wx" === r ? o = n(44) : "hap" === r ? o = n(45) : "nodejs" === r && (o = n(46)), e.exports = o
  }, function(e, t, n) {
    (function(t) {
      const o = n(0),
        r = n(21),
    ...
    e.exports = function(e) {
      ...
      return e ? (o.forEach(e.split("\n"), function(e) {
        if (s = e.indexOf(":"), t = o.trim(e.substr(0, s)).toLowerCase(), n = o.trim(e.substr(s + 1)), t) {
    ...
    r.prototype = new Error, r.prototype.code = 5, r.prototype.name = "InvalidCharacterError", e.exports = function(e) {
      for (var t, n, s = String(e), i = "", a = 0, c = o; s.charAt(0 | a) || (c = "=", a % 1); i += c.charAt(63 & t >> 8 - a % 1 * 8)) {
    ...
    e.exports = o.isStandardBrowserEnv() ? {
      write: function(e, t, n, r, s, i) {
        var a = [];
        a.push(e + "=" + encodeURIComponent(t)), o.isNumber(n) && a.push("expires=" + new Date(n).toGMTString()), o.isString(r) && a.push("path=" + r), o.isString(s) && a.push("domain=" + s), !0 === i && a.push("secure"), document.cookie = a.join("; ")
      },
      read: function(e) {
    ...
    e.exports = function(e) {
      return u(e), e.baseURL && !a(e.url) && (e.url = c(e.baseURL, e.url)), e.headers = e.headers || {}, e.data = r(e.data, e.headers, e.transformRequest), e.headers = o.merge(e.headers.common || {}, e.headers[e.method] || {}, e.headers || {}), o.forEach(["delete", "get", "head", "post", "put", "patch", "common"], function(t) {
        delete e.headers[t]
    ...
    e.exports = ((e, t = "get", s = {}) => new Promise((i, a) => {
      ...
      u && (c["X-Bmob-Session-Token"] = u.sessionToken), wx.request({
        url: o._config.host + e,
        method: t,
        data: s,
        header: c,
        success: e => {
          (e.data.code && e.data.error || e.data.error) && a(e.data), i(e.data)
        },
        fail: e => {
          console.log(e), a(e)
        }
    ...
    let o = n(0);
    e.exports = ((e, t = "get", r = {}) => new Promise((s, i) => {
      const a = (e => {
        let t = {
          "content-type": "application/json",
      ...
      void 0 === o.User && (o = n(0));
      let c = o.User.current();
      c && (a["X-Bmob-Session-Token"] = c.sessionToken), "object" == typeof r && (r = JSON.stringify(r)), "require('@system.fetch')".fetch({
        url: o._config.host + e,
        header: a,
        method: t,
        data: r,
    ...
    const s = {
      save(e, t) {
        if (!o(e) || !t) throw new Error(415);
        r.setItem(e, JSON.stringify(t))
      },
      fetch(e) {
        if (!o(e)) throw new Error(415);
    ...
    const {
      ...
      save(e, t) {
        if (!o(e) || !t) throw new Error(415);
        return t = r(t) ? JSON.stringify(t) : t, wx.setStorageSync(e, t)
      },
      fetch(e) {
        if (!o(e)) throw new Error(415);
    ...
    const {
      isString: o
    } = n(2), r = "xxrequire('@system.storage')xx", s = {
      save(e, t) {
        if (!o(e) || !t) throw new Error(415);
        r.set({
          key: e,
    ...
    e.exports = class extends s {
      ...
      decryption(e) {
        ...
        return new Promise((n, r) => {
          ...
          let u;
          const l = {
              sessionKey: u = "undefined" != typeof tt ? c.authData.toutiao.session_key : c.authData.weapp.session_key,
              encryptedData: a,
              iv: s
            },
            p = i._config.parameters.DECRYPTION;
          o(p, "POST", l).then(e => {
            n(e)
          }).catch(e => {
            r(e)
      ...
      requestOpenId(e, t = "") {
        const n = i._config.parameters.WECHAT_APP;
        return o(n + e, "POST", {
          anonymous_code: t
        })
      }
      ...
      loginWithWeapp(e, t = "") {
        return new Promise((n, o) => {
          this.requestOpenId(e, t).then(e => {
            ...
            "undefined" != typeof tt && (delete e.error, t = {
              toutiao: e
            });
            const o = this.linkWith(t);
            n(o)
          }).catch(e => {
            o(e)
          })
      ...
      upInfo(e) {
        return new Promise((t, n) => {
          ...
          let c = r.fetch("openid");
          this.get(i.objectId).then(e => {
            e.set("nickName", o), e.set("userPic", s), e.set("openid", c), e.save().then(e => {
              t(e)
            }).catch(e => {
              console.log(e), n(e)
            })
      ...
      auth() {
        ...
        return new Promise((t, n) => {
          const o = () => {
            wx.login({
              success: o => {
                console.log(o);
                let s = "";
                "undefined" != typeof tt && (s = o.anonymousCode), e.loginWithWeapp(o.code, s).then(e => {
                  if (e.error) throw new a(415);
                  let n;
                  n = "undefined" != typeof tt ? e.authData.toutiao.openid : e.authData.weapp.openid, r.save("openid", n), r.save("bmob", e), t(e)
                }, function(e) {
                  n(e)
                })
              }
          ...
          wx.checkSession({
            success: function() {
              let r = e.current();
              null === r && n("登陆错误，请在Bmob后台填写小程序AppSecret。"), t(r), o()
            },
            fail: () => {
              o()
            }
    ...
    e.exports = class {
      ...
      save() {
        ...
        return "h5" === t || "nodejs" === t ? e = new Promise((e, t) => {
          const n = [];
          for (let r of l) o(r.route, "post", r.data).then(o => {
            n.push(o), n.length === l.length && (l = [], e(n), t(n))
          }).catch(e => {
            n.push(e)
          })
          ...
          const i = [],
            a = {
              _ApplicationId: r._config.applicationId,
              _RestKey: r._config.applicationKey,
              _SessionToken: o
            },
            c = Object.assign({
          ...
          for (let n of l) wx.uploadFile({
            ...
            success: function(n) {
              ...
              i.push(o), i.length === l.length && (l = [], e(i), t(i))
            },
            fail: function(e) {
              i.push(e)
            }
          ...
          void 0 === r.User && (r = n(0));
          let o = r.User.current();
          const s = [],
            i = {
              _ApplicationId: r._config.applicationId,
              _RestKey: r._config.applicationKey,
              _SessionToken: o.sessionToken
            },
            c = Object.assign({
              _ContentType: "text/plain",
              mime_type: "text/plain",
          ...
          for (let n of l) a.upload({
            ...
            success: function(n) {
              ...
              let o = n.data;
              s.push(o), s.length === l.length && (l = [], e(s), t(s))
            },
            fail: function(e, t) {
              console.log(`handling fail, code = ${t}`)
            }
      ...
      destroy(e) {
        if (c(e)) return o(`${r._config.parameters.FILES}/upyun/${e.split(".com/")[1]}`, "delete");
        if (u(e)) {
          const t = [];
          return e.map(e => {
    ...
    e.exports = class {
      weApp(e, t, n) {
        let i = wx.getStorageSync("openid");
    ...
    t.exports = class {
      constructor() {
        if (!r._config.applicationId) throw new s(415);
        this.config = {
          host: "wss.bmobcloud.com"
        }, i.setup(this.emitter = {}), this.applicationId = r._config.applicationId, this.initialize()
      }
      handshake() {
        let t = "https://" + this.config.host + "/socket.io/1/?t=" + (new Date).getTime(),
          n = JSON.stringify({});
        return new Promise((o, r) => {
          wx.request({
            ...
            success: function(t) {
              return t.data && t.data.statusCode ? o("request error", e) : 200 !== t.statusCode ? o("request error", e) : o(function(e) {
      ...
      connect(e, t) {
        const n = Object.keys(t).map(e => `${e}=${encodeURIComponent(t[e])}`).join("&"),
          o = e.indexOf("?") > -1 ? "&" : "?";
        return e = [e, n].join(o), new Promise((n, o) => {
          wx.onSocketOpen(n), wx.onSocketError(o), wx.onSocketMessage(e => {
            try {
              let t = function(e) {
                  const {
                    name: t,
              ...
              let s = null == r ? "" : JSON.parse(r[0]);
              this.emitter.emit(o, s)
            } catch (t) {
    ...
    e.exports = {
      ...
      sendMessage: e => 1,
      getAccessToken: e => {
        let t = r._config.parameters.GETACCESSTOKEN;
        return o(t, "get")
      },
      sendWeAppMessage: e => {
        if (!i(e)) throw new s(415);
    ...
    e.exports = {
      ...
      verifySmsCode: (e, t, n) => {
        ...
        let c = `${r._config.parameters.VERIFYSMSCODE}/${e}`;
        return o(c, "post", t)
      }
    }
  }])
